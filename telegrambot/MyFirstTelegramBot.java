...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    ...
    public static final String NAME = "MariaFernandaAlvezBot_bot";
    public static final String TOKEN = "7376838746:AAGRWTzwyYUmxgfSsb8iaIl_Leq5h-I4X80";
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (getCallbackQueryButtonKey().equals("step_4_btn")){
            ...
            sendTextMessageAsync (STEP_5_TEXT,
                    Map.of ("¡Colocate la GoPro y enciendela! +30 de fama", "step_5_btn"));
        }
        ...
        if (getCallbackQueryButtonKey().equals("step_5_btn")){
            ...
            sendTextMessageAsync (STEP_6_TEXT,
                    Map.of ("¡Grabar contenido para un blog! +40 de fama", "step_6_btn",
                            "¡Grabar al humano! +40 de fama", "step_6_btn",
                            "¡Grabar al vecino! +40 de fama", "step_6_btn"));
        }
